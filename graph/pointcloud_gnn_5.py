...
# torch.save(model.state_dict(), "data/pretrained/geometric_shape_point_net.pth")

# model = PointNet()
# model.load_state_dict(torch.load("data/pretrained/geometric_shape_point_net.pth"))
# model.eval()
